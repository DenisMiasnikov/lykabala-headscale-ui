...
import { ChevronRightIcon, ChevronDownIcon, TrashIcon, XIcon } from "../components/Icons";
...
export default function MachinesPage() {
  ...
  const groupedMachines: Record<string, Machine[]> = machines.reduce((acc, machine) => {
                          ...
                          <tbody>
                            {userMachines.map((machine) => (
                              <tr key={machine.id} className="machine-row">
                                <td>
                                  <a href={`/machines/${machine.id}`}>{machine.givenName}</a>
                                </td>
                                  ...
                                  {deleteConfirmations[machine.id] ? (
                                    <div className="action-buttons-group">
                                      ...
                                      <button
                                        ...
                                        onClick={() => cancelDeleteConfirmation(machine.id)}
                                        title="Cancel"
                                      >
                                        <XIcon />
                                      </button>
                                    ...
                                    <button
                                      className="button secondary action-button"
                                      onClick={() => showDeleteConfirmation(machine.id)}
                                      title="Delete"
                                    >
                                      <TrashIcon />
                                    </button>
